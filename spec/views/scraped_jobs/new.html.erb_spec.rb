...
describe "scraped_jobs/new" do
  before(:each) do
    assign(:scraped_job, stub_model(ScrapedJob,
      :title => "MyString",
      :company_id => 1,
      :title => "MyString",
      :url => "MyString",
  ...
  it "renders new scraped_job form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => scraped_jobs_path, :method => "post" do
