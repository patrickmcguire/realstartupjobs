...
def is_technical(title)
 ...
 def submit_job(company_id, title, description, experience_required, url, source, source_unique_id, date_posted, time)
  ...
  puts "Verified: source: " + source + " " + title + " intern: " + is_internship(title).to_s + " technical: " + technical.to_s
      ...
      puts "New: source: " + source + " " + title + " intern: " + is_internship(title).to_s + " technical: " + technical.to_s
